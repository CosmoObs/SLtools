...
void cc_tan_siep(double siep_params[],int npts=1000, FILE *file_in1=NULL, FILE *file_in2=NULL){
...
void cc_lw_pos_siep(double siep_params[], double lw_th=10.0, int npts=1000, FILE *file_in1=NULL, FILE *file_in2=NULL){
...
void cc_lw_neg_siep(double siep_params[], double lw_th=10.0, int npts=1000, FILE *file_in1=NULL, FILE *file_in2=NULL){
...
void cc_rad_siep(double siep_params[], int npts=1000, FILE *file_in1=NULL, FILE *file_in2=NULL){
...
//   y1_ccr[i]= fabs(y1_siep(x1_ccr[i]/b, x2_ccr[i]/b,siep_params));  
//   y2_ccr[i]= fabs(y2_siep(x1_ccr[i]/b, x2_ccr[i]/b,siep_params)); 

  y1_ccr[i]= fabs(x1_ccr[i]/b-sqrt(a1e)*cos(theta_e));  
  y2_ccr[i]= fabs(x2_ccr[i]/b-sqrt(a2e)*sin(theta_e)); 

  fprintf(file_in1,"%lg %lg \n", x1_ccr[i]/b, x2_ccr[i]/b);
  fprintf(file_in2,"%lg %lg \n", y1_ccr[i]/b, y2_ccr[i]/b);
...
// x1_rn= r_th_siep(theta,siep_params,-rth)*cos(theta_e)/sqrt(a1e);
//   x2_rn= r_th_siep(theta,siep_params,-rth)*sin(theta_e)/sqrt(a2e);
//   
//   x1_rp= r_th_siep(theta,siep_params,rth)*cos(theta_e)/sqrt(a1e);
//   x2_rp= r_th_siep(theta,siep_params,rth)*sin(theta_e)/sqrt(a2e);
