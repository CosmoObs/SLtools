...
\bea
f_1&=&\re\left[ab\left(J_0\,cos^2\te+J_1\,sen^2\te\right)-1\right]\label{f1-sie}
\\[10pt]
\frac{{\rm d}f_0}{{\rm
d}\te}&=&ab\,\frac{\re^2}{2}\left(J_1-J_0\right)sen\,2\te\label{df0-sie}\\[10pt]
\frac{{\rm d}^2f_0}{{\rm
d}\te^2}&=&ab\,\re^2\left[\left(J_1-J_0\right)cos\,2\te+\frac{\re^2}{2}
\left(K_0-2K_1+K_2\right)sen^22\te\right]\label{d2f0-sie}
\eea
...
\epsilon\cos\,2\theta}{6}\right)\\
J_1(r,\te)-J_0(r,\te)&=&\frac{\sigma}{r}\frac{2\epsilon}{3}
\eea
and
\bea
