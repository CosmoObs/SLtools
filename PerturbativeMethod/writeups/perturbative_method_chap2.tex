...
Note that this changes the notation of the first eq in \cite{Alard07} eq.~3
...
which changes the notation in \cite{Alard07} eq.~4 (which is somewhat weird notation,
...
This is \cite{Alard07} eq.~30. From this last equation, the tangential critical
...
\bea
\kappa &=& {1 \over 2} \lp 2 f_2 + \oorsq \pptsqfz + \oor f_1 \rp \\
\gamma_1 &=&   {1 \over 2} \lp \costwot \lp 2 f_2 - \oorsq \pptsqfz - \oor f_1
\rp + \sintwot \lp \oorsq \pptfz - \twoor \pptfone \rp \rp \\
\gamma_2 &=&   \half \sintwot \lp 2 f_2 - \oorsq \pptsqfz - \oor f_1 \rp +
