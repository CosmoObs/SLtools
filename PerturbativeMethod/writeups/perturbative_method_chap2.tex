...
\bea
r_{+}(\te)&=&\left|\vec{r}_{\mathrm{crit}}\right|\left(1+\frac{1}{|N|-1}
\right)\label{rmax}\\
r_{-}(\te)&=&\left|\vec{r}_{\mathrm{crit}}\right|\left(1-\frac{1}{|N|+1}
\right)\label{rmin}
\eea
...
\bea
\sigma_{dcs}=\kappa_2^2\frac{|N|^2+1}{\left(|N|^2-1\right)^2}\int_0^{2\pi}\left|\vec{
